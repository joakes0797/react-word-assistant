...
export function SearchForm() {
    // var guess = words;
    const [guess, setGuess] = useState(words);
    ...
    return (
        <>
            <form onSubmit={formik.handleSubmit}>
                ...
                <div className="green-letters" style={{backgroundColor: "mediumseagreen", paddingBottom: "20px", paddingTop: "1px"}}>
                ...
                <div className="yellow-letters" style={{backgroundColor: "gold", paddingBottom: "20px", paddingTop: "1px"}}>
                ...
                <div className="gray-letters" style={{backgroundColor: "gray", paddingBottom: "20px", paddingTop: "1px"}}>
            ...
            <h1>&#11015; Below are some possible answers &#11015;</h1>
            <ul>
                {
                    guess.map(function (item, i) {
...
//                                 <h3>Enter green letters in their exact spot.</h3>
//                                 <input onChange={props.handleChange} value={props.values.B01} type="text" pattern="[a-zA-Z]" title="No spaces, numbers, or special characters." id="B01" name="B01" maxLength="1" />
//                                 <input onChange={props.handleChange} value={props.values.B02} type="text" pattern="[a-zA-Z]" title="No spaces, numbers, or special characters." id="B02" name="B02" maxLength="1" />
//                                 <input onChange={props.handleChange} value={props.values.B03} type="text" pattern="[a-zA-Z]" title="No spaces, numbers, or special characters." id="B03" name="B03" maxLength="1" />
//                                 <input onChange={props.handleChange} value={props.values.B04} type="text" pattern="[a-zA-Z]" title="No spaces, numbers, or special characters." id="B04" name="B04" maxLength="1" />
//                                 <input onChange={props.handleChange} value={props.values.B05} type="text" pattern="[a-zA-Z]" title="No spaces, numbers, or special characters." id="B05" name="B05" maxLength="1" />
//                             </div>
//                             <div className="yellow-letters">
//                                 <h3>Enter any yellow letters.</h3>
//                                 <input onChange={props.handleChange} value={props.values.B06} type="text" pattern="[a-zA-Z]" title="No spaces, numbers, or special characters." id="B06" name="B06" maxLength="1" />
//                                 <input onChange={props.handleChange} value={props.values.B07} type="text" pattern="[a-zA-Z]" title="No spaces, numbers, or special characters." id="B07" name="B07" maxLength="1" />
//                                 <input onChange={props.handleChange} value={props.values.B08} type="text" pattern="[a-zA-Z]" title="No spaces, numbers, or special characters." id="B08" name="B08" maxLength="1" />
//                                 <input onChange={props.handleChange} value={props.values.B09} type="text" pattern="[a-zA-Z]" title="No spaces, numbers, or special characters." id="B09" name="B09" maxLength="1" />
//                                 <input onChange={props.handleChange} value={props.values.B10} type="text" pattern="[a-zA-Z]" title="No spaces, numbers, or special characters." id="B10" name="B10" maxLength="1" />
//                             </div>
//                             <div className="gray-letters">
//                                 <h3>Enter up to 10 gray letters.</h3>
//                                 <input onChange={props.handleChange} value={props.values.B11} type="text" pattern="[a-zA-Z]" title="No spaces, numbers, or special characters." id="B11" name="B11" maxLength="1" />
//                                 <input onChange={props.handleChange} value={props.values.B12} type="text" pattern="[a-zA-Z]" title="No spaces, numbers, or special characters." id="B12" name="B12" maxLength="1" />
//                                 <input onChange={props.handleChange} value={props.values.B13} type="text" pattern="[a-zA-Z]" title="No spaces, numbers, or special characters." id="B13" name="B13" maxLength="1" />
//                                 <input onChange={props.handleChange} value={props.values.B14} type="text" pattern="[a-zA-Z]" title="No spaces, numbers, or special characters." id="B14" name="B14" maxLength="1" />
//                                 <input onChange={props.handleChange} value={props.values.B15} type="text" pattern="[a-zA-Z]" title="No spaces, numbers, or special characters." id="B15" name="B15" maxLength="1" />
//                                 <br></br>
//                                 <input onChange={props.handleChange} value={props.values.B16} type="text" pattern="[a-zA-Z]" title="No spaces, numbers, or special characters." id="B16" name="B16" maxLength="1" />
//                                 <input onChange={props.handleChange} value={props.values.B17} type="text" pattern="[a-zA-Z]" title="No spaces, numbers, or special characters." id="B17" name="B17" maxLength="1" />
//                                 <input onChange={props.handleChange} value={props.values.B18} type="text" pattern="[a-zA-Z]" title="No spaces, numbers, or special characters." id="B18" name="B18" maxLength="1" />
//                                 <input onChange={props.handleChange} value={props.values.B19} type="text" pattern="[a-zA-Z]" title="No spaces, numbers, or special characters." id="B19" name="B19" maxLength="1" />
//                                 <input onChange={props.handleChange} value={props.values.B20} type="text" pattern="[a-zA-Z]" title="No spaces, numbers, or special characters." id="B20" name="B20" maxLength="1" />
//                             </div>
//                             <button type="submit">Submit</button>
